...
public class TeamsLocalDataSourceTest {
    ...
    @Test
    public void getTeam_whenNotExistsTeam_onDataNotAvailableIsSuccessful() {
        ...
        sTeamsLocalDataSource.getTeam(ID, callback);
    }

    @Test
    public void getTeam_whenExistsTeam_onTeamsLoadedIsSuccessful() {
        ...
        Team team1 = new Team(TEAM_ID_1, TEAM_NAME_1, team1Players, new ArrayList<Supporter>());
        Team team2 = new Team(TEAM_ID_2, TEAM_NAME_2, team2Players, new ArrayList<Supporter>());
        ...
        TeamsDataSource.LoadTeamsCallback callback = new TeamsDataSource.LoadTeamsCallback() {
            ...
            public void onTeamsLoaded(List<Team> teams) {
                ...
                Team team1 = expectedTeams.get(0);
        ...
        sTeamsLocalDataSource.getTeam(team1.getId(), callback);
    }
